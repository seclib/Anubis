...
from cli.agents import CORE_AGENTS, AgentRegistry
...
class CommandRouter:
    """Framework-free command router for ANUBIS CLI."""
    ...
    def _swarm(self, command: ParsedCommand) -> RouteResult:
        ...
        return RouteResult(f"Swarm {result.goal}", self.agent_states, result.render())


__all__ = ["CommandRouter", "ParsedCommand", "RouteResult"]
